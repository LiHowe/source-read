  ...
  <div>
    <div class="info">
      ...
      <section class="info-detail">
        <p v-for="key in Object.keys(currentLocation)" :key="key">
          <p><b>{{key}}: </b></p> 
          <pre :id="key">{{ currentLocation[key] }}</pre>
        </p>
      </section>
    </div>
    <!-- <section class="info">
...
import { useLink, useRoute } from '../source/src'
...
export default defineComponent({
  ...
  setup() {
    ...
    const state = inject('state') // cancelNextNavigation
